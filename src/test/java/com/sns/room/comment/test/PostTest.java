...
public class PostTest implements CommonTest {
    ...
    PostRequestDto TEST_POST_REQUEST_DTO = new PostRequestDto(TEST_POST_ID,TEST_POST_TITLE, TEST_POST_CONTENT, TEST_PHOTO,TEST_MODIFIEDAT);
    PostRequestDto TEST_ANOTHER_POST_DTO = new PostRequestDto(TEST_ANOTHER_POST_ID,ANOTHER_PREFIX+TEST_POST_TITLE, ANOTHER_PREFIX+TEST_POST_CONTENT, ANOTHER_PREFIX+TEST_PHOTO,TEST_MODIFIEDAT);
